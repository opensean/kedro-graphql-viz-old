...
import { BasicApolloClient } from "./apollo-client.composition";

import { useCounter } from "./apollo-client"
...
describe("BasicApolloClient", () => {
  it("should render", async () => {
    const { getByText, findByText } = render(BasicApolloClient);
